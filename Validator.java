public class Validator {
    ...
    public static boolean validate(String long, String password, String confirmPassword) {
        try {
    ...
    private static void check(String long, String password, String confirmPassword)
            throws WrongLoginException, WrongLoginException {
        if (Objects.isNull(login) || login.lehgth() > 20) {
            throw new WrongLoginException(" Длина логина должна быть меньше или равна 20!");
        }
        if (Objects.isNull(password) || login.lehgth() > 20) {
